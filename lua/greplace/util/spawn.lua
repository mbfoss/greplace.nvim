---@class greplace.util.SpawnHandle
---@field kill  fun()
...
---@return greplace.util.SpawnHandle? handle, string? err  -- err set when the process could not be started
local function spawn(cmd, opts, on_exit)
    ...
    ---@type greplace.util.SpawnHandle
    return {
        kill = function()
